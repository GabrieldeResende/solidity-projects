...
contract ResendeNFT is ERC721, ERC165, ERC721Metadata, ERC721Enumerable {
    ...
    function mint() public {
        ...
        _uris[_lastId] = string.concat(
            "https://gabrielresende.com.br/nfts/",
    ...
    function ownerOf(uint256 _tokenId) external view returns (address) {
        address owner = _ownerOf[_tokenId];
        require(owner != address(0), "The token dos not exists");
        return owner;
    }
    ...
    function getApproved(uint256 _tokenId) external view returns (address) {
        require(_ownerOf[_tokenId] != address(0), "The token dos not exists");
